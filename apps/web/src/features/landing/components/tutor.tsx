...
const tutors: Tutor[] = [
  {
    ...
    description:
      "Giảng dạy dễ hiểu, giúp học sinh nắm vững kiến thức Toán THPT và ôn thi đại học.",
    rating: 4.9,
    price: "60k/giờ",
    image:
  ...
  },
  {
    ...
    description:
      "Sinh viên năm cuối Đại học Bách Khoa, có 3 năm kinh nghiệm dạy kèm Lý Hóa.",
    rating: 5.0,
    price: "75k/giờ",
    image:
  ...
  },
  {
    ...
    description:
      "Hướng dẫn lập trình cơ bản Python, Java cho sinh viên và người mới bắt đầu.",
    rating: 4.9,
    price: "85k/giờ",
    image:
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-16">
          <div className="mb-8 flex items-end justify-between">
            ...
            <a
              className="hidden items-center gap-1 text-sm font-bold text-primary hover:text-primary/80 sm:flex"
              href="#"
            >
              Xem tất cả gia sư →
            </a>
          ...
          <div className="mx-auto max-w-7xl">
            <div className="mb-12 text-center">
              ...
              <p className="text-muted-foreground">
                Nghe từ những người đã trải nghiệm và thay đổi nhờ Edura
              </p>
            </div>
              ...
              {[
                ...
                >
                  ...
                  <div className="flex items-center gap-3 border-t border-border pt-4">
                    <div
                      className={`flex size-10 items-center justify-center rounded-full font-bold ${story.color}`}
                    >
                      {story.initials}
                    </div>
                    <div>
