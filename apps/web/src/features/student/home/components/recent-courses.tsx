    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {COURSES.map((course, i) => (
          <Card
            key={i}
            className="group border-none shadow-sm hover:shadow-xl transition-all overflow-hidden rounded-2xl"
          >
            <CardContent className="p-0">
              ...
              <div className="p-6 space-y-4">
                ...
                <Button
                  asChild
                  variant="secondary"
                  className="w-full font-bold rounded-xl bg-muted hover:bg-info hover:text-info-foreground transition-all"
                >
                  <Link href="/student/my-courses/1">Tiếp tục bài học</Link>
                </Button>
              </div>
            </CardContent>
          </Card>
